...
public class KeySet   {
  ...
  public KeySet keys(List<Key> keys) {
    this.keys = keys;
    return this;
  }

  public KeySet addKeysItem(Key keysItem) {
    if (this.keys == null) {
  ...
  /**
   * conjunto de chaves ec
   * @return keys
  **/
  @ApiModelProperty(value = "conjunto de chaves ec")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.keys, keySet.keys);
  }
